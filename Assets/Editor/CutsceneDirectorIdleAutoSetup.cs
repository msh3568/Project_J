...
public static class CutsceneDirectorIdleAutoSetup
{
    ...
    private static void SetupOpeningDialogue(GameObject directorObject, PlayableDirector director)
    {
        ...
        if (addedComponent)
        {
            ...
            SetBool(serializedObject, "forceConversationFacing", true);
            SetBool(serializedObject, "keepConversationFacingWhileTimelineRuns", true);
            SetBool(serializedObject, "playerFacesRight", true);
            SetBool(serializedObject, "npcFacesRight", false);
            SetBool(serializedObject, "npcLooksAtPlayer", true);
            SetBool(serializedObject, "invertNpcFacing", false);
            SetBool(serializedObject, "overrideNpcSpriteFlipX", true);
            SetBool(serializedObject, "npcSpriteFlipX", false);
            SetBool(serializedObject, "preferDynamicFontSource", true);
            SetBool(serializedObject, "keepBubbleReadableWhenActorFlipped", true);
            SetBool(serializedObject, "playerBubbleFlipX", false);
            SetBool(serializedObject, "playerTextFlipX", false);
            SetBool(serializedObject, "npcBubbleFlipX", false);
            SetBool(serializedObject, "npcTextFlipX", false);
